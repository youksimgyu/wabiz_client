...
abstract class $HomeModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? totalCount, List<HomeItemModel> projects});
}
...
class _$HomeModelImpl implements _HomeModel {
  const _$HomeModelImpl(
      {this.totalCount, final List<HomeItemModel> projects = const []})
      : _projects = projects;
  ...
  @override
  String toString() {
    return 'HomeModel(totalCount: $totalCount, projects: $projects)';
  }
